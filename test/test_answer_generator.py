import csv, json
from model import MistralAnswerGenerator, LLaMA3AnswerGenerator, PaLMAnswerGenerator, OpenAIAnswerGenerator
...
def main(question_generator, test_file, kb_file, retrieval_results_file,vqa_results=None):
