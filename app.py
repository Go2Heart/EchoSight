...
def run(knowledge_base_path, faiss_index_path, **kwargs):
    ...
    answer_generator = MistralAnswerGenerator(model_path=kwargs["llm_ckpt"], device="cuda:0", use_embedding_model=False)
    ...
    def vqa(image, question):
        ...
        if kwargs["use_reranker"]:
            ...
            with torch.cuda.amp.autocast():
                ...
                for section_spilit in range(0, len(qformer_articles), 500):
                    article_embs = blip_model.extract_features({
                        "text_input": qformer_articles[section_spilit:section_spilit+500]
            ...
            return answer_generator.llm_answering(question,entry_section=reranked_sections[0])
        else:
...
if __name__ == "__main__":
    ...
    app_config = {
        ...
        "llm_ckpt":"/PATH/TO/LLM_CHECKPOINT"
    }
    run(**app_config)